...
export function Counters({
  ...
  return (
    <section className="border-b border-line bg-surface">
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-4 py-14 sm:py-16 md:grid-cols-4">
        {counters.map((c) => (
          <div key={c.id} className="text-center">
            <div className="font-display text-4xl font-extrabold text-brand lg:text-5xl">
