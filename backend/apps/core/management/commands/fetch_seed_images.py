...
SUBJECTS: list[tuple[str, str, tuple[int, int], str, str]] = [
    ...
    ("cases/case3-before.jpg", "teeth closeup", (1200, 900), "none — demo only", "teeth before"),
    ("cases/case3-after.jpg", "white teeth smile", (1200, 900), "none — demo only", "smile after"),
    ("cases/case4-before.jpg", "teeth dental", (1200, 900), "none — demo only", "teeth before"),
    ("cases/case4-after.jpg", "smiling teeth", (1200, 900), "none — demo only", "smile after"),
